...
11.In the search box to the right of  Services, search for and choose EC2 to open the EC2 console.<br>
12.In the left navigation pane, choose Instances.<br>
In the center pane, there should be a running instance that is named App Server.<br>
13.Select the App Server instance.<br>
