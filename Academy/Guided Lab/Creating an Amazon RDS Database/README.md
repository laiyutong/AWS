...
10.In the search box to the right of  Services, search for and choose <code>EC2 to open the EC2 console.<br><br>
11.In the left navigation pane, choose I<code>nstances</code>.<br>
